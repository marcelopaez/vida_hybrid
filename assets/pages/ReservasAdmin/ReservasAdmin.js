      ...
      <div className="col-lg-10 col-md-9 col-sm-12 bg-white p-3">
        <div className="generalContentBody">
          ...
          <div className="reservasAdminSearch">
            <input type="text" className="form-control" className="reservasAdminInput" ref={clientSelected} />
            <svg width="23" height="23" viewBox="0 0 23 23" className="reservasAdminSearchSVG" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav>
              <ul className="pagination">
                <li className="page-item ">
                  <a className="page-link reservasAdminPagination" tabIndex="-1">
                    Anterior
                  </a>
                </li>
                <li className="page-item">
                  <a className="page-link reservasAdminPagination">1</a>
                </li>
                <li className="page-item active">
                  <a className="page-link reservasAdminPagination">
                    2 <span className="sr-only">(current)</span>
                  </a>
                </li>
                <li className="page-item">
                  <a className="page-link reservasAdminPagination">3</a>
                </li>
                <li className="page-item ">
                  <a className="page-link reservasAdminPagination">Siguiente</a>
                </li>
              </ul>
            </nav>
          </div>
