        ...
        <div className="generalContentAdminBody">
          ...
          <div className="contractAdminContractContainer">
            <div className="contractAdminContractLeft">
              <p className="contractAdminContractLeftTitle extraBoldFont">Plan Eter</p>
              <div className="contractAdminContractLeftSeparator"></div>
              <div className="contractAdminContractLeftFirstSection">
                ...
                <p className="contractAdminContractLeftFirstSectionDescription boldFont">
                  1 día a la semana <br /> PART: Incluye 3 Hs. en salas de reunión
                </p>
              </div>
              <div className="contractAdminContractLeftSeparator"></div>
              <div className="contractAdminContractLeftSecondSection">
                ...
                <p className="contractAdminContractLeftSecondSectionDescription boldFont">
                  Fecha de firma <br />
                  12/10/2021
                </p>
              </div>
              <div className="contractAdminContractLeftSeparator"></div>
              <div className="contractAdminContractLeftThirdtSection">
                ...
                <p className="contractAdminContractLeftThirdtSectionDescription boldFont">
            ...
            <div className="contractAdminContractRight">
              <div className="contactAdminContractRightNameContainer">
                ...
                <p className="contractAdminContractRightName">
                  Nombre <br />
                  DNI
                </p>
              </div>
              <p className="contractAdminContractRightDescription lightFont">
              ...
              <div className="contactAdminContractRightStatusContainer">
                ...
                <p className="contractAdminContractRightStatus">
                  Nombre <br />
                  DNI
                </p>
              </div>
