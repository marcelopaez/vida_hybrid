    ...
    <main id="modal">
        ...
        <div className="background" style={{ backgroundImage: `url(${BackgroundImage})`, backgroundSize: 'cover' }}>
          <div className="leftSVGNavbar">
            <div className="officesHeaderContent">
              <p className="officesTitle extraBoldFont" id="modal">
                Oficinas privadas
              </p>
      ...
      <div className={`${reservationConfirmationModal ? 'officesContainerLargerOfficesBlur' : 'officesContainerLargerOffices'}`}>
        <div className="leftSVGNavbar" style={{ marginTop: '-100px', backgroundImage: `url(${BackgroundImage})`, backgroundSize: 'cover' }}>
          <div className="officesHeaderContent">
            <p className="officesTitle officesTitleExtraMargin extraBoldFont" id="modal">
              Oficinas privadas
            </p>
            <p className="officesSubtitle">Si buscás privacidad, tenemos espacios con capacidad para 4 hasta 26 personas.</p>
            <p className="officesText officesTextExtraMargin">Adaptamos nuestras oficinas a equipos numerosos.</p>
          </div>
        </div>
        ...
        <div className="customContainer">
          <div className="officesReservationContainer">
            ...
            <button className="officesReservationButton" onClick={() => setReservationConfirmationModal(false)}>
              Enviar
            </button>
          </div>
        </div>
      ...
      <div className={`${reservationConfirmationModal ? 'officesContainerMobileOfficesBlur' : 'officesContainerMobileOffices'}`}>
        ...
        <div className="customContainer">
          ...
          <div className="officesReservationContainerMobile">
            ...
            <button className="officesReservationButtonMobile" onClick={() => setReservationConfirmationModal(false)}>
              Enviar
            </button>
          </div>
        </div>
