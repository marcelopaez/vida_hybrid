...
const ComunidadBeneficiosAdmin = () => {
  ...
  return (
    <div className="row marginNavbar generalContent">
      ...
      <div className="col-lg-2 col-md-3 col-sm-12 sideMenu sideMenuComunidadBeneficiosAdmin">
        <SideMenuAdmin />
      </div>
      <div className="col-lg-10 col-md-9 col-sm-12 px-3 panelContentComunidadBeneficiosAdmin">
