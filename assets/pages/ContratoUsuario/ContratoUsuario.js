...
const ContratoUsuario = () => {
  ...
  return (
    <div className="row marginNavbar generalContent">
      ...
      <div className="col-lg-2 col-md-3 col-sm-12 sideMenu sideMenuContratoUsuario">
        <SideMenu />
      </div>

      <div className="col-lg-10 col-md-9 col-sm-12 bg-white px-3 panelContentContratoUsuario">
