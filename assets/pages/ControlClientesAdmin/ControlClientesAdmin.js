...
const ControlClientesAdmin = () => {
  ...
  return (
    <div className="row marginNavbar generalContent">
      ...
      <div className="col-lg-2 col-md-3 col-sm-12 sideMenu sideMenuControlClientesAdmin">
        <SideMenuAdmin />
      </div>

      <div className="col-lg-10 col-md-9 col-sm-12 px-3 backgroundAdmin panelContentControlClientesAdmin">
        <div className="generalContentBody">
          <h1 className="controlClientesAdminTitle extraBoldFont">Reservas realizadas</h1>
          <div className="controlClientesAdminSearch">
            <input type="text" className="form-control" className="controlClientesAdminInput" ref={clientSelected} />
            <svg width="23" height="23" viewBox="0 0 23 23" className="controlClientesAdminSearchSVG" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="controlClientesAdminFilterButtonsContainer">
            <svg width="24" height="25" viewBox="0 0 24 25" fill="#0e4327" xmlns="http://www.w3.org/2000/svg" className="controlClientesAdminFilterLogo">
              <path
            ...
            <div className="controlClientesAdminFilterButton">
          ...
          <div className="table-responsive controlClientesAdminTable">
            <table className="table">
              <thead className="controlClientesAdminPrimaryColorDarkerRow">
                <tr>
              ...
              <tbody>
                <tr className="controlClientesAdminRowHover">
                  <td scope="row">Mes</td>
                  <td>Mes</td>
                  <td>Hora</td>
                  <td>Tipo de Sala</td>
                  <td>
                    <button className="controlClientesAdminCancelButton">
            ...
            <nav>
              <ul className="pagination">
                <li className="page-item ">
                  <a className="page-link controlClientesAdminPagination" tabIndex="-1">
                    Anterior
                  </a>
                </li>
                <li className="page-item">
                  <a className="page-link controlClientesAdminPagination">1</a>
                </li>
                <li className="page-item active">
                  <a className="page-link controlClientesAdminPagination">
                    2 <span className="sr-only">(current)</span>
                  </a>
                </li>
                <li className="page-item">
                  <a className="page-link controlClientesAdminPagination">3</a>
                </li>
                <li className="page-item ">
                  <a className="page-link controlClientesAdminPagination">Siguiente</a>
                </li>
              </ul>
            </nav>
          </div>

          <p className="controlClientesAdminAvailabilityTitle extraBoldFont">Disponibilidad de salas</p>
          <div className="controlClientesAdminFilterButtonsContainer">
            <div className="controlClientesAdminFilterButton">
              <svg width="27" height="27" viewBox="0 0 27 27" fill="#fff" className="mx-2" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="controlClientesAdminRoomsContainer">
            <div className="controlClientesAdminRoomContainer">
              <p className="controlClientesAdminRoomContainerTitle">Sala</p>
              <div className="controlClientesAdminRoomContainerImage"></div>
              <div className="controlClientesAdminRoomContainerDataContainer">
                <div className="controlClientesAdminRoomContainerData">
                  <div className="controlClientesAdminRoomContainerDataImage"></div>
                  <p className="controlClientesAdminRoomContainerDataText">Dato 1</p>
                </div>
                <div className="controlClientesAdminRoomContainerData">
                  <div className="controlClientesAdminRoomContainerDataImage"></div>
                  <p className="controlClientesAdminRoomContainerDataText">Dato 2</p>
                </div>
              </div>
            </div>
