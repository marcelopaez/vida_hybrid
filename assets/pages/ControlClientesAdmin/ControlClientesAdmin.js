      ...
      <div className="col-lg-10 col-md-9 col-sm-12 p-3" style={{ backgroundColor: '#e5e5e5' }}>
        <div className="row generalContentBody">
          <div className="col-lg-8 col-md-8 col-sm-12">
            <p className="controlClientesAdminTitle extraBoldFont">Planes</p>
            <div className="controlClientesAdminPlanesContainer">
              <div className="controlClientesAdminPlan">
                <p className="controlClientesAdminPlanTitle">Eter</p>
                <hr />
                <p className="controlClientesAdminPlanQuantity extraBoldFont">24</p>
                <p className="controlClientesAdminPlanDetail lightFont">Personas suscritas</p>
              </div>

              <div className="controlClientesAdminPlan">
                <p className="controlClientesAdminPlanTitle">Aire</p>
                <hr />
                <p className="controlClientesAdminPlanQuantity extraBoldFont">24</p>
                <p className="controlClientesAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
              ...
              <div className="controlClientesAdminPlan">
                <p className="controlClientesAdminPlanTitle">Agua</p>
                <hr />
                <p className="controlClientesAdminPlanQuantity extraBoldFont">24</p>
                <p className="controlClientesAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
              ...
              <div className="controlClientesAdminPlan">
                <p className="controlClientesAdminPlanTitle">Fuego</p>
                <hr />
                <p className="controlClientesAdminPlanQuantity extraBoldFont">24</p>
                <p className="controlClientesAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
              ...
              <div className="controlClientesAdminPlan">
                <p className="controlClientesAdminPlanTitle">Tierra</p>
                <hr />
                <p className="controlClientesAdminPlanQuantity extraBoldFont">24</p>
                <p className="controlClientesAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
            ...
            <p className="controlClientesAdminNumbersTitle extraBoldFont">Números generales</p>

            <div className="controlClientesAdminGeneralNumbersContainer">
              <div className="controlClientesAdminGeneralNumbers">
                ...
                <div className="controlClientesAdminGeneralNumbersSeparator"></div>
                <div>
                  <p className="controlClientesAdminGeneralNumbersTitle">Ingresos totales</p>
                  <div className="controlClientesAdminGeneralNumbersAmount extraBoldFont">$25464</div>
                </div>
              </div>
              ...
              <div className="controlClientesAdminGeneralNumbers">
                ...
                <div className="controlClientesAdminGeneralNumbersSeparator"></div>
                <div>
                  <p className="controlClientesAdminGeneralNumbersTitle">Total usuarios</p>
                  <div className="controlClientesAdminGeneralNumbersAmount extraBoldFont">464</div>
                </div>
              </div>
              ...
              <div className="controlClientesAdminGeneralNumbers">
                ...
                <div className="controlClientesAdminGeneralNumbersSeparator"></div>
                <div>
                  <p className="controlClientesAdminGeneralNumbersTitle">Total planes vendidos</p>
                  <div className="controlClientesAdminGeneralNumbersAmount extraBoldFont">25464</div>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-4 col-sm-12">
            <div className="controlClientesAdminRightSide">
              <p className="controlClientesAdminRightSideTitle extraBoldFont">Detalle</p>
              <div className="controlClientesAdminRightSideDetail">
                <div className="controlClientesAdminRightSideDetailTitle">Tierra</div>
                <hr />
                <p className="controlClientesAdminRightSideDetailNumber extraBoldFont">24</p>
                <p className="controlClientesAdminRightSideDetailText lightFont">Personas suscritas</p>
              </div>
            </div>
          </div>
        </div>
