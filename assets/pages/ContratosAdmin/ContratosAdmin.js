...
const ContratosAdmin = () => {
  ...
  return (
    <div className="row marginNavbar generalContent">
      ...
      <div className="col-lg-2 col-md-3 col-sm-12 sideMenu sideMenuContratosAdmin">
        <SideMenuAdmin />
      </div>

      <div className="col-lg-10 col-md-9 col-sm-12 px-3 backgroundAdmin panelContentContratosAdmin">
        <div className="row generalContentBody">
          <div className="col-xl-9 col-lg-12 col-md-12 col-sm-12">
            ...
            <div className="contratosAdminFilterButtonsContainer">
              <svg width="24" height="25" viewBox="0 0 24 25" fill="#7D7C7A" xmlns="http://www.w3.org/2000/svg" className="contratosAdminFilterLogo">
                <path
              ...
              <div className="contratosAdminFilterButton">
            ...
            <div className="table-responsive contratosAdminTable">
              <table className="table">
                ...
                <tbody>
                  <tr className="contratosAdminRowHover">
                    <td>39496091</td>
          ...
          <div className="col-xl-3 col-lg-12 col-md-12 col-sm-12">
            <div className="contratosAdminRightSide">
              <div className="contratosAdminRightSideHeader">
                <div className="contratosAdminRightSideHeaderImage"></div>
                <p className="contratosAdminRightSideHeaderName">Nombre, Apellido</p>
              </div>
              <hr />
              <p className="contratosAdminRightSidePersonalDataTitle boldFont">Datos personales</p>
              <p className="contratosAdminRightSidePeronalData">DNI</p>
              <p className="contratosAdminRightSidePeronalData">Fecha de Nacimiento</p>
              <p className="contratosAdminRightSidePeronalData">Ocupación</p>
              <p className="contratosAdminRightSidePeronalData">User IG</p>
              <p className="contratosAdminRightSidePeronalData">User LI</p>
              <hr />
              <p className="contratosAdminRightSidePersonalDataTitle boldFont">Datos de contacto</p>
              <p className="contratosAdminRightSidePeronalData">Teléfono/celular</p>
              <p className="contratosAdminRightSidePeronalData">Info</p>
              <p className="contratosAdminRightSidePeronalData">Info</p>

              <div className="contratosAdminRightSideActualPlan">
                <p className="contratosAdminRightSideActualPlanTitle boldFont">Suscrito a plan Eter</p>
                <p className="contratosAdminRightSideActualPlanDetail">Part</p>
              </div>
              ...
              <div className="contratosAdminRightSideContractContainer">
                <p className="contratosAdminRightSideContractTitle">Contrato</p>
                <div className="contratosAdminRightSideContract">
                  <div className="contratosAdminRightSideContractData">
                ...
                <p className="contratosAdminRightSideContractDownload">Descargar</p>
              </div>
            </div>
          </div>
        </div>
