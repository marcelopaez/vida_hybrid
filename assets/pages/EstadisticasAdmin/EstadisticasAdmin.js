      ...
      <div className="col-lg-10 col-md-9 col-sm-12 px-3 mb-3 backgroundAdmin">
        <div className="row generalContentBody">
          <div className="col-xl-9 col-lg-12 col-md-12 col-sm-12">
            ...
            <div className="estadisticasAdminPlanesContainer">
              <div className="estadisticasAdminPlan">
                <p className="estadisticasAdminPlanTitle boldFont">Eter</p>
                <hr />
                <p className="estadisticasAdminPlanQuantity extraBoldFont">24</p>
                <p className="estadisticasAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
              <hr className="estadisticasAdminPlanSeparator" />

              <div className="estadisticasAdminPlan">
                <p className="estadisticasAdminPlanTitle boldFont">Aire</p>
                <hr />
                <p className="estadisticasAdminPlanQuantity extraBoldFont">24</p>
                <p className="estadisticasAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
              ...
              <div className="estadisticasAdminPlan">
                <p className="estadisticasAdminPlanTitle boldFont">Agua</p>
                <hr />
                <p className="estadisticasAdminPlanQuantity extraBoldFont">24</p>
                <p className="estadisticasAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
              ...
              <div className="estadisticasAdminPlan">
                <p className="estadisticasAdminPlanTitle boldFont">Fuego</p>
                <hr />
                <p className="estadisticasAdminPlanQuantity extraBoldFont">24</p>
                <p className="estadisticasAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
              ...
              <div className="estadisticasAdminPlan">
                <p className="estadisticasAdminPlanTitle boldFont">Tierra</p>
                <hr />
                <p className="estadisticasAdminPlanQuantity extraBoldFont">24</p>
                <p className="estadisticasAdminPlanDetail lightFont">Personas suscritas</p>
              </div>
            ...
            <div className="estadisticasAdminDailyReservationsContainer">
              <div className="estadisticasAdminDailyReservationsElement">
                <p className="estadisticasAdminDailyReservationsElementTitle boldFont">DÍA</p>
                <p className="estadisticasAdminDailyReservationsElementNumber extraBoldFont">5</p>
                <p className="estadisticasAdminDailyReservationsElementDetail lightFont">Reservas registradas</p>
              </div>
              <hr className="estadisticasAdminDailyReservationsSeparator" />
              <div className="estadisticasAdminDailyReservationsElement">
                <p className="estadisticasAdminDailyReservationsElementTitle boldFont">SEMANA</p>
                <p className="estadisticasAdminDailyReservationsElementNumber extraBoldFont">24</p>
                <p className="estadisticasAdminDailyReservationsElementDetail lightFont">Reservas registradas</p>
              </div>
              <hr className="estadisticasAdminDailyReservationsSeparator" />
              <div className="estadisticasAdminDailyReservationsElement">
                <p className="estadisticasAdminDailyReservationsElementTitle boldFont">MES</p>
                <p className="estadisticasAdminDailyReservationsElementNumber extraBoldFont">56</p>
                <p className="estadisticasAdminDailyReservationsElementDetail lightFont">Reservas realizadas</p>
              </div>
            </div>
            <p className="estadisticasAdminNumbersTitle extraBoldFont">Números generales</p>
            <div className="estadisticasAdminGeneralNumbersContainer">
              <div className="estadisticasAdminGeneralNumbers">
                ...
                <div className="estadisticasAdminGeneralNumbersSeparator"></div>
                <div>
                  <p className="estadisticasAdminGeneralNumbersTitle">Ingresos totales</p>
                  <div className="estadisticasAdminGeneralNumbersAmount extraBoldFont">$25464</div>
                </div>
              </div>
              ...
              <div className="estadisticasAdminGeneralNumbers">
                ...
                <div className="estadisticasAdminGeneralNumbersSeparator"></div>
                <div>
                  <p className="estadisticasAdminGeneralNumbersTitle">Total usuarios</p>
                  <div className="estadisticasAdminGeneralNumbersAmount extraBoldFont">464</div>
                </div>
              </div>
              ...
              <div className="estadisticasAdminGeneralNumbers">
                ...
                <div className="estadisticasAdminGeneralNumbersSeparator"></div>
                <div>
                  <p className="estadisticasAdminGeneralNumbersTitle">Total planes vendidos</p>
                  <div className="estadisticasAdminGeneralNumbersAmount extraBoldFont">25464</div>
                </div>
              </div>
            </div>
          ...
          <div className="col-xl-3 col-lg-12 col-md-12 col-sm-12">
            <div className="estadisticasAdminRightSide">
              <p className="estadisticasAdminRightSideTitle extraBoldFont">Detalle</p>
              <div className="estadisticasAdminRightSideDetail">
                <div className="estadisticasAdminRightSideDetailTitle">Tierra</div>
                <hr className="estadisticasAdminRightSideDetailSeparator" />
                <p className="estadisticasAdminRightSideDetailNumber extraBoldFont">24</p>
                <p className="estadisticasAdminRightSideDetailText lightFont">Personas suscritas</p>
              </div>
            </div>
          </div>
        </div>
