      ...
      <div className="col-lg-10 col-md-9 col-sm-12 p-3">
        <div className="row generalContentBody">
          <div className="col-lg-8 col-md-12 col-sm-12">
            ...
            <h1 className="sectionTitle">Tipos de salas disponibles</h1>
            <div className="roomTypesSection">
              <div className="roomType">
                <img src={RoomType1} alt="Mesa Rusa" />
                <p className="roomTypeTitle">Título</p>
                <p className="roomTypeContent">Permite deliberar sobre temas de interés, acordar o negociar.</p>
              </div>
              <div className="roomType">
                <img src={RoomType2} alt="Herradura" />
                <p className="roomTypeTitle">Título</p>
                <p className="roomTypeContent">Una óptima visión tanto de los integrantes como del disertante o proyección.</p>
              </div>
              <div className="roomType">
                <img src={RoomType3} alt="Taller" />
                <p className="roomTypeTitle">Título</p>
                <p className="roomTypeContent">Excelente opción para trabajar de manera colaborativa.</p>
              </div>
              <div className="roomType">
                <img src={RoomType4} alt="Escuela" />
                <p className="roomTypeTitle">Título</p>
                <p className="roomTypeContent">Con mesas para escribir o disfrutar del catering.</p>
              </div>
              <div className="roomType">
                <img src={RoomType5} alt="Imperial" />
                <p className="roomTypeTitle">Título</p>
                <p className="roomTypeContent">Una gran mesa con los participantes sentados en torno a ella.</p>
              </div>
              <div className="roomType">
                <img src={RoomType6} alt="Auditorio" />
                <p className="roomTypeTitle">Título</p>
                <p className="roomTypeContent">El público se encuentra sentado frente un disertante.</p>
              </div>
              <div className="roomType">
                <img src={RoomType7} alt="Libre" />
                <p className="roomTypeTitle">Título</p>
                <p className="roomTypeContent">Distribución ideal para generar interacción entre los asistentes</p>
              </div>
              <div className="roomType">
                <img src={RoomType8} alt="Outdoor" />
                <p className="roomTypeTitle">Título</p>
                <p className="roomTypeContent">Podes elegir realizarlo al aire libre y rodeado de naturaleza.</p>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-12 col-sm-12">
            ...
            <div className="currentPlanContainer">
              ...
              <div className="currentPlanContent mt-3">
                <p>Estás suscripto al plan Eter</p>
              </div>
              <hr className="whiteSeparator" />
              <div className="currentPlanContent mb-3">
                <p className="font-weight-bold">1 día a la semana</p>
                <p>PART: Incluye 3 Hs. en salas de reunión</p>
                <div className="d-flex justify-content-center">
                  <button className="buttonContainer">Ver planes</button>
                </div>
              </div>
            </div>
          </div>
