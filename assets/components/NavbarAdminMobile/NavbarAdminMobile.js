...
const NavbarAdminMobile = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbarLoginMobile fixed-top navbar-light d-flex">
      ...
      <Link to="/">
        <img src={Logo} alt="Vida" loading="lazy" width="150px" />
      </Link>
      <div className="collapse navbar-collapse" id="navbarMobileVida">
        <div className="navbarAdminDataMobile">
          <img src={Notifications} alt="Vida Cowork" className="notificationsIconMobile" onClick={() => setShowNotifications(!showNotifications)} />
          {showNotifications && (
            <div className="notificationAdminMobileContainer">
              <div className="notificationAdminMobileHeader">
                <p className="notificationAdminMobileTitle extraBoldFont">Notificaciones</p>
                <p className="notificationAdminMobileX" onClick={() => setShowNotifications(!showNotifications)}>
                  X
                </p>
              </div>
              <div className="blockAdminMobileSeparator"></div>
              <div className="notificationAdminMobile">
                <svg className="notificationAdminMobileSVG" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="notificationAdminMobileText">¡Tu reserva se guardó con éxito!</p>
              </div>
              <div className="blockAdminMobileNotificationSeparator"></div>
              <div className="notificationAdminMobile">
                <svg className="notificationAdminMobileSVG" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="19" cy="19" r="19" fill="#A6A6A6" />
                  <path
          ...
          <p className="navbarAdminNameMobile boldFont">Nombre Apellido</p>
          <div className="fakeProfilePictureAdminMobile"></div>
          <div className="arrowProfileAdminMobile"></div>
        </div>
      </div>
    </nav>
  );
